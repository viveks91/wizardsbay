...
public class Item {
    ...
    @ApiModelProperty(value = "Username of the buyer (set to null when item is created)")
    ...
    @ApiModelProperty(value = "Username of the seller", required = true)
    ...
    @ApiModelProperty(value = "Item description", required = true)
    ...
    @ApiModelProperty(value = "Auction start time (set to 'now' when item is created)", allowableValues = "yyyy-MM-dd hh:mm:ss a")
    ...
    @ApiModelProperty(value = "Time when the auction ends", required = true, allowableValues = "yyyy-MM-dd hh:mm:ss a (> now)")
    ...
    @ApiModelProperty(value = "Minimum bid amount", required = true)
